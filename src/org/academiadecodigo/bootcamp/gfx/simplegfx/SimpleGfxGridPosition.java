...
public class SimpleGfxGridPosition extends AbstractGridPosition {
    ...
    public SimpleGfxGridPosition(int col, int row, SimpleGfxGrid grid, int type){
        ...
        simpleGfxGrid = grid;
        if(type == 0) {
            pic = new Picture((col * grid.getCellSize()) + grid.getX(), (row * grid.getCellSize()) + grid.getY(), "playerCarFinal.png");
        }else if(type == 1) {
            pic = new Picture((col * grid.getCellSize()) + grid.getX(), (row * grid.getCellSize()) + grid.getY(), "dragao teste 2.png");
